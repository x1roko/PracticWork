...
namespace TaskManagerMiac.Migrations
{
    ...
    [Migration("20250130150600_auth-password23")]
    partial class authpassword23
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("TaskManagerMiac.Models.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            IdRole = 1,
                            IsActive = true,
                            LastEnterDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Password = "$2a$11$cT8irG7/Ag.RKhxa48PWq.QVQR6jQHVefczIHo.lPs.ryau8OQVfW",
